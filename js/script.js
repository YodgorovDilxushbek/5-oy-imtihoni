...
function validateForm() {
  const logo = form.querySelector('#logo1');
  const companyName = form.querySelector('#Mange');
  const position = form.querySelector('.text3'); 
...
form.addEventListener("submit", function (event) {
  ...
  const logo = form.querySelector('#logo1').value;
  const companyName = form.querySelector('#Mange').value;
  const isNew = form.querySelector('.checkbox.is-new').checked; 
  const isFeatured = form.querySelector('.checkbox.is-featured').checked; 
  const position = form.querySelector('.text3').value; 
  const time = form.querySelector('#vaqtlar').value; 
  const jobType = form.querySelector('#ish').value;
  const location = form.querySelector('#davlat').value;
  const skills = [];
